...
set "mod_name=Plasmocat's 'BG NPC Portraits in BG2 Style'"
set mod_version=v5
set mod_folder=plasmobg1bg2
...
set mod_readme=https://gibberlings3.github.io/Documentation/readmes/readme-plasmobg1bg2.html
